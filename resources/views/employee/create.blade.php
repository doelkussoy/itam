        ...
        <div class="card-body">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <select name="position_id" class="form-control @error('position_id') is-invalid @enderror" >
                        ...
                        @foreach($positions as $pos)
                            <option value="{{ $pos->id }}" style="color: #000;" {{ old('position_id') == $pos->id ? 'selected' : '' }}>{{ $pos->name }}</option>
                        @endforeach
                    </select>
            ...
            <div class="row">
                <div class="col-md-4 form-group">
                    ...
                    <input type="text" name="extension" class="form-control @error('extension') is-invalid @enderror" value="{{ old('extension') }}" placeholder="e.g. 102">
