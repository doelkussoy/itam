...
<div class="card theme-card">
    <div class="card-header border-0">
        ...
        <div class="card-tools d-flex" style="gap: 10px;">
            <a href="{{ route('brands.export') }}" class="btn btn-sm btn-success"><i class="fas fa-file-excel"></i> {{ __('messages.export') }}</a>
                    ...
                    <tr>
                        ...
                        <td class="theme-text">
                            <div class="d-flex justify-content-center" style="gap: 8px;">
                                <a href="{{ route('brands.edit', $item) }}" class="btn action-btn btn-outline-warning" style="border: 1px solid rgba(255, 193, 7, 0.3); background: rgba(255, 193, 7, 0.15); color: #ffc107;"  title="{{ __('messages.edit') }}"><i class="fas fa-edit"></i></a>
    ...
    <div class="modal-content">
      <form action="{{ route('brands.import') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-header">
          <h5 class="modal-title" id="importModalLabel"><i class="fas fa-file-import text-info mr-2"></i> {{ __('messages.import_excel') }} {{ __('messages.brand') }}</h5>
